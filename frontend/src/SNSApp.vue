        ...
        <div>
            ...
            <v-navigation-drawer app clipped flat v-model="sideBar">
                <v-list>
                    ...
                    <v-list-item
                        class="px-2"
                        key="allocationManagements"
                        to="/allocationmanagements/allocationManagements"
                        @click="changeUrl()"
                        color="primary"
                        style="font-weight:700;"
                    >
    ...
    data: () => ({
        ...
        aggregate: [
            ...
            { 
                ...
                description: '', 
                key: 'allowanceChecks', 
                route: '/allowances/allowanceChecks',
                ImageUrl: '',
            },
            { 
                ...
                description: '', 
                key: 'allocationManagements', 
                route: '/allocationmanagements/allocationManagements',
                ImageUrl: '',
            },
